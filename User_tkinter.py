...
def pegar_all_dados():
    ...
    aviso.place(relx=0.3, rely=0.6, anchor="center")
# Frame =======================
frame_1 = tk.Frame(janela, bd= 4, bg="lightblue", highlightbackground="blue", highlightthickness=2)
frame_1.place(relx=0.3,rely=0.35,relwidth=0.5,relheight=0.7,anchor="center")
#=======================
